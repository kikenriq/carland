  ...
  <div className='relative flex-1'>
    ...
    justify-center items-center xl:items-start xl:pl-8'>
          ...
          gap-y-2 xl:gap-y-0'>
            ...
            <div className='flex item gap-x-3 xl:ml-6'>
              <div className='text-[13px] font-medium text-secundary'>
                {format(date[0].startDate, 'dd/MM/yyy')}</div>
    ...
    {/* menu */}
    <Menu.Items className='dropdown-menu shadow-lg absolute -top-96 xl:top-[90px]
